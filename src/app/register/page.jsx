            ...
            <div className="bg-white shadow-2xl rounded-lg px-7 py-7 xl:w-1/3 md:w-100 2xl:w-2/6 md:h-130 sm:w-1/2 flex flex-col gap-5 justify-center">
                <div>
                    <div className="flex justify-center items-center gap-2">
                        ...
                        <h1 className="text-3xl var(--font-montserrat) font-bold xl:text-4xl">CRUD OPERATIONS</h1>
                    </div>
                    <div className="flex flex-col justify-center items-center gap-2 mt-5 xl:text-1xl">
                        <h1 className="[var(--font-montserrat)] font-semibold xl:text-2xl">REGISTER</h1>
                        <p className="text-[#6C6C6C] [var(--font-montserrat)] font-regular">Enter your information to create your account</p>
                    </div>
                </div>
                <form className="flex flex-col gap-4 px-2">
                    <div className="flex flex-col gap-2 [var(--font-montserrat)] font-medium">
